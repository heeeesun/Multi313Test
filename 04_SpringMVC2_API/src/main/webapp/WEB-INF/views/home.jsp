...
<section id="content">
	...
	<a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=f91048891574f679b693e1465499fd78&redirect_uri=http://localhost/mvc/member/enroll/kakao">
	...
	<!-- REST API 키 =  client_id -->
	<h3>로그인</h3>
	<a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=f91048891574f679b693e1465499fd78&redirect_uri=http://localhost/mvc/kakaoLogin">
